...
public class Board {
    ...
    private Board(Builder builder){
        ...
        this.whitePieces = calculateActivePices(this.gameBoard, Alliance.WHITE);
        this.blackPieces = calculateActivePices(this.gameBoard, Alliance.BLACK);
    }

    private Collection<Piece> calculateActivePices(final List<Tile> gameBoard,
